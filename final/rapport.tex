...
IL est disponible sur toutes les plateformes, de Windows à la Xbox, en passant par Linux et la Playstation 3.
...
\begin{center}
\includegraphics[scale = 0.35]{interface3.png}\\
...
\begin{center}
\includegraphics[scale =0.7]{we-need-to-go-deeper.jpg}
\end{center}
...
\begin{center}
\includegraphics[scale=0.6]{c_caml.jpg}
...
Pour la première soutenance, nous avions créé une ébauche de site web. Pour la deuxième soutance, tout le squelette du site web a été mis en place. En effet nous avions très vite choisi de créer le site web en HTML, ce qui ne permettait pas de faire une interface trop esthétique. Nous avons donc tout mise sur la visibilité de l'information.\\

Pour la dernière soutenance, notre site est pleinement fonctionnel. Là où nous avions une ébauche, les pages web ont été completées. Les utilisateurs peuvent donc acceder à toutes les informations dont ils pourraient avoir besoins.

\begin{center}
\includegraphics[scale=0.25]{site1.png}
\end{center}

Le site se compose de différentes vues donnant, en autre, des informations sur l'équipe, des explications sur les différentes parties de P.R.O.J.E.T. --- par exemple, des images, une présentation détaillée \ldots

\begin{center}
\includegraphics[scale=0.25]{site2.png}
\end{center}

Il sera possible également de télécharger les sources du projet et de laisser des commentaires dans un livre d'or dédié. En outre, il est possible de contatcer directement l'équipe pour tout problêmes, remarques, soucis, choses pas claires \ldots

\chapter{Joies et tristesses}

Ce semestre fut émaillé de nombreuses épreuves mais aussi de bons moments. 

La première de ces difficultés a été de faire cohabiter pacifiquement le C et l'OCaml, deux langages structurellement très différents. Un autre problème est survenu lors de l'implémentation de la playlist. Nous nous devions de la faire fonctionner parfaitement, ceci étant une composante primordiale d'un lecteur audio. Le bouton \emph{Next} posa beaucoup de soucis, notamment à cause de son interaction avec Gtk. Mais, le summum du défi fut atteint lors de l'affichage de la pochette. Cette fois, ce fut entre le C et l'OCaml qu'il fallut résoudre les conflits. Enfin, certains membres se plaignèrent allègrement de l'utilisation du gestionnaire Git.\\

Heureusement, quelques satisfactions nous permirent de tenir bon. Le premier fut la lecture de notre premier son. Également l'implémentation du volume et de la playlist fonctionnelle nous provoqua beaucoup de joie.
Mais, paradoxalement, l'apothéose de notre jouissance fut ressentit lorsqu'enfin la pochette de l'album en cours apparu devant nos yeux ébahis.

\chapter*{Conclusion}

Nous avons dans ce rapport développé les principales parties de P.R.O.J.E.T. Nous avons donc la possibilité de fournir un programme complet et entièrement fonctionnel.\\

L'équipe a eût la chance de rester soudée tout au long du projet, et a été capable de surmonter moults difficultés et une foultitude de problêmes: chaque personne étant prête a délaisser son travail pour aider un autre membre.\\

Ce projet nous a apporté de nombreuses connaissances dans des domaines divers et variés, entre autres, l'utilisation de FMOD et de GTK+, ainsi que dans l'utilisation du language C.  Le travail en équipe a été décisif dans la réussite de notre entreprise.\\

Pour finir, nous sommes fiers du travail accompli et d'avoir un programme terminé.


\begin{center}
\includegraphics[scale =0.3]{conclu.jpg}
\end{center}
